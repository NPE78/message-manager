...
/**
 * This exception is raised when a message type is added twice in the {@link MMDictionary}
 * Created by NicolasP on 23/10/2015.
 */
public class MessageTypeAlreadyDefinedException extends RuntimeException {
